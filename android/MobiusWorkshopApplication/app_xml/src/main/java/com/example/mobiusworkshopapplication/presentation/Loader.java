...
public class Loader
    extends View implements ValueAnimator.AnimatorUpdateListener {
  ...
  private void init(AttributeSet attrs, int defStyle) {
    ...
    if (loader != null) {
      ...
      loader = AppCompatResources.getDrawable(getContext(),
                                              R.drawable.ic_preloader_24);
    }
  ...
  public void show() { fade(true); }

  public void hide() { fade(false); }

  private void fade(boolean show) { setVisibility(show ? VISIBLE : GONE); }
  ...
  public void stop() { loaderAnimator.cancel(); }

  public void start() { loaderAnimator.start(); }
  ...
  public enum Type { SPINNER, FADER }
}
